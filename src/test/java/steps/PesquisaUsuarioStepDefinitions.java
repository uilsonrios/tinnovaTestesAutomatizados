...
public class PesquisaUsuarioStepDefinitions {
    ...
    public void clico_no_botao_adicionar_para_validar_as_informações_do_usuário()  {
        driver.findElement(By.xpath("//*[@id="root"]/div/div[2]/div[2]/div[4]/div[5]/div[1]/svg/path")).click();
    }

    @E("^valido o nome completo do usuario$") /*É validado o nome do usuario*/
    public void valido_o_nome_completo_do_usuario() {
      Webelement nomeText  driver.findElement(By.linkText("Mario Roberto"));
    ...
    public void valido_o_email_do_usuario() {
      Webelement emailText  driver.findElement(By.linkText("teste@teste.com.br"));
    ...
    public void valido_o_cpf_do_usuario() {
      Webelement cpfUsuario  driver.findElement(By.linkText('240.099.110-34'));
    ...
    public void valido_o_telefone_do_usuario() {
      Webelement telefoneUsuario  driver.findElement(By.linkText('42999999999'));
      String telefoneUsuarioText = telefoneUsuario.getText();
      AssertEquals(expect: '42999999999',telefoneUsuarioText );
    }
