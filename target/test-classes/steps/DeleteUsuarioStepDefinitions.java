...
public class DeleteUsuarioStepDefinitions {
    ...
    public void clico_no_botao_deletar_para_realizar_a_exclusao_do_usuário()  {
    ...
    public void valido_a_mensagem_que_apresenta_pra_exclusão_do_usuario()  {
    ...
    @Entao("^clico no botão sim para excluir o usuário") /*Realiza o click no botão Atualizar*/
